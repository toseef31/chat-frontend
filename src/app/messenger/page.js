    ...
    <div className='grid grid-cols-3 items-center justify-center h-screen'>
        <div className='col-start-2'>
          <div className='text-center'>
            <label className='font-bold text-2xl'>Please Login to Mesasger</label>
          </div>
          <div className='flex flex-col items-center my-3'>
            ...
            <div className='w-10/12 my-2'>
              <button className="btn rounded-md border w-full py-2.5 bg-violet-600 text-white font-bold">Login</button>
            </div>
          </div>
        </div>
    </div>
